  ...
  for(int e = 0; e < EXTRUDERS; e++) 
  {
    ...
    pid_input = current_temperature[e];
        ...
        if(pid_error[e] > PID_FUNCTIONAL_RANGE) {
          ...
          //songhuilin
          pid_output = (constrain(pTerm[e] + iTerm[e] - dTerm[e], 0, PID_MAX))*1;
        }
    ...
    #else
    if(current_temperature[e] < (target_temperature[e] - 10)) {
      pid_output = PID_MAX*0;
    }else if (current_temperature[e] < target_temperature[e]) {
      pid_output = (PID_MAX*0);
    }
    #endif
    #endif
